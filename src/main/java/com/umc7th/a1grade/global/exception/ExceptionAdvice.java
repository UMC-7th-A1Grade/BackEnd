...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> validation(ConstraintViolationException e, WebRequest request) {
    ...
    return handleExceptionInternalConstraint(
        e, CommonErrorStatus.valueOf(errorMessage), HttpHeaders.EMPTY, request);
  }
  ...
  public ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    return handleExceptionInternalArgs(
        e, HttpHeaders.EMPTY, CommonErrorStatus.valueOf("_BAD_REQUEST"), request, errors);
  }
  ...
  public ResponseEntity<Object> exception(Exception e, WebRequest request) {
    ...
    return handleExceptionInternalFalse(
        ...
        HttpHeaders.EMPTY,
        CommonErrorStatus._INTERNAL_SERVER_ERROR.getHttpStatus(),
        request,
        e.getMessage());
  }
  ...
  private ResponseEntity<Object> handleExceptionInternalFalse(
      Exception e,
      CommonErrorStatus errorCommonStatus,
      HttpHeaders headers,
      HttpStatus status,
      WebRequest request,
      String errorPoint) {
  ...
  private ResponseEntity<Object> handleExceptionInternalConstraint(
      Exception e, CommonErrorStatus errorCommonStatus, HttpHeaders headers, WebRequest request) {
    ApiResponse<Object> body =
